...
export class Genesis {
  constructor(config, options = {}) {
    ...
    this.repositoryUrl = options.repositoryUrl || 'https://github.com/Ramestta-Blockchain/genesis-contracts'
    this.maticContractsRepository = 'matic-contracts'
    this.maticContractsRepositoryUrl = 'https://github.com/Ramestta-Blockchain/contracts'
  }
